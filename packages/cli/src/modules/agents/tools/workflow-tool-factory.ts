...
async function backgroundWaitingExecution(
	...
	if (receipt.status === 'duplicate') {
		return {
			...
			jobId: receipt.existingJobId,
			note: `This execution is already tracked as background job ${receipt.existingJobId}. Use check_background_jobs for the result. Do not start the workflow again.`,
		};
	}
