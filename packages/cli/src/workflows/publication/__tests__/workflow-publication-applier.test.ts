...
describe('WorkflowPublicationApplier', () => {
	...
	describe('policy enforcement', () => {
		...
		// Broken ownership data must not stop a publication; the check gets a null scope.
		test('still enforces with a null project when ownership cannot be resolved', async () => {
